            ...
            <div className="row m-4">
                ...
                <div className="card col-md m-auto">
                    <div className="card-body" id="about-card">
                        ...
                        <h6 className="card-subtitle text-muted mt-1 mb-1">Academic</h6>
                        ...
                        <h6 className="card-subtitle text-muted mb-1">Activities</h6>
                        <p className="card-text">Camping, exploring, wood-working, gardening, painting, ice cream-making, folk music, archery</p>
                        <h6 className="card-subtitle text-muted mb-1">Instruments</h6>
                        <p className="card-text">Fiddle, Guitar, Ukulele, Mandolin, Banjo</p>
                        <h6 className="card-subtitle text-muted mb-1">Spoken Languages</h6>
