                ...
                <div className="row p-4">
                    <div className="col-lg">
                        <form id="conctactForm">
                            ...
                            <div class={submitSuccessMessageClass} role="alert" id="alert-success"> Message submitted! Thanks for going out on a limb and reaching out! (Just kidding -- I'm going to respond. I just wanted the picture to make sense.)
                            </div>
                        </form>
                    </div>
